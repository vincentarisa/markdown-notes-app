...
export default function SideBar(props){
    ...
    function confirmDeletion(){
        ...
        console.log(props.noteTitle + " Deleted Succesfully")
    }
    return(
                            ...
                            <div className="modal-body">
                                <div>
                                    ...
                                    <div className="d-flex p-3">
                                        <button type="submit" className="btn btn-danger w-100" onClick={confirmDeletion} data-bs-dismiss="modal">Accept</button>
